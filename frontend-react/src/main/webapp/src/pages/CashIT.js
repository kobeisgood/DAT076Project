...
export default class CashIt extends React.Component{
    ...
    componentDidMount(){
        ...
        .then(loggedIn => {
            console.log("CASH IT MOUNT: " + loggedIn)
      ...
      return (
		...
		<div className="general-styling">
			...
			<div className="content-container">
				<Switch>
				<ProtectedRoute exact path="/frontend-react/dashboard" component={(props) => <Dashboard handleDashboardClick={this.setMonthlyView} {...props}/>}></ProtectedRoute>
