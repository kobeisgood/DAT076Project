...
public class AccountDAOTest {
    ...
    public void createAccountTest() throws Exception{
        ...
        Response sameMailResponse = client.target(deploymentURL + "api/users")
         ...
         // Register new user
        JSONUser.put("mail","test@gmail.com");
        Response newUserResponse2 = client.target(deploymentURL + "api/users")
                .request(MediaType.APPLICATION_JSON)
                .post(Entity.entity(JSONUser, MediaType.APPLICATION_JSON));
        ...
        assertEquals(newUserResponse2.getStatusInfo(), Response.Status.OK);
    ...
    public void loginTest() throws Exception{
        ...
        String password = JSONUser.getAsString("password");
        JSONUser.remove("id");
        ...
        Response updateUserDupicateMail = client.target(deploymentURL + "api/users")
                .request(MediaType.APPLICATION_JSON)
                .cookie("JSESSIONID",JSESSIONID)
                .put(Entity.entity(JSONUser, MediaType.APPLICATION_JSON));
        ...
        assertEquals(wrongMailFormat.getStatusInfo(), Response.Status.BAD_REQUEST);
        assertEquals(updateUserDupicateMail.getStatusInfo(), Response.Status.CONFLICT);
